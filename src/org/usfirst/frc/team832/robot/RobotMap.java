...
//	public static Spark bigWinch;
	...
	public static final int winchID = 6;
...
//	public static CANTalon collectorRoller;
	...
	public static void init() {
		...
		left1.setVoltageRampRate(128); // DO NOT CHANGE THIS FROM 128
		right1.setVoltageRampRate(128); // DO NOT CHNAGE THIS FROM 128
...
//		bigWinch = new Spark(0);
		winch = new CANTalon(winchID);
		winch.clearStickyFaults();
